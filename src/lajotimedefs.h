...
#define elevator1minspeeddefault        8      
#define elevator2minspeeddefault        8   
...
#define hatchstoprepositiondelayms      2000
#define hatchrepositionspeed            50.0f
#define hatchapproachspeed              50.0f
#define hatchfullspeed                  100.0f
#define hatchrepositiontolerance        1
#define hatchslowdownadvance            5

// ---------- testing ------------
#define hatchsimulatorintervalms        200
#define testposerr                      10
